...
from models.PoseLossAlternative import PoseLossAlternative
import comet_ml
...
class PoseEstimationTrainer:
    ...
    def __init__(self, model, train_loader, val_loader, device=torch.device("cpu"), config=None, experiment=None, resume_optimizer=False, checkpoint=None):
        ...
        # self.criterion = PoseLossAlternative(alpha=1.0, beta=1.0)
    ...
    def train_epoch(self):
        ...
        for batch_idx, batch in enumerate(pbar):
            ...
            # compute loss
            loss = self.criterion(pred_trans, pred_rot, gt_trans, gt_rot, obj_id)
